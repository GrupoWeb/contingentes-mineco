...
class solicitudesemisionController extends crudController
{
    ...
    public function __construct()
    {
        ...
        Crud::setCampo(['nombre' => 'Usuario', 'campo' => 'u.nombre']);
        Crud::setCampo(['nombre' => 'Empresa', 'campo' => 'e.razonsocial']);
        Crud::setCampo(['nombre' => 'Tratado', 'campo' => 't.nombrecorto']);
        Crud::setCampo(['nombre' => 'Fraccion', 'campo' => 'cp.partida']);
        Crud::setCampo(['nombre' => 'Producto', 'campo' => 'd.nombre']);
        Crud::setCampo(['nombre' => 'Fecha de solicitud', 'campo' => 'solicitudesemision.created_at', 'tipo' => 'datetime']);
        Crud::setCampo(['nombre' => 'Monto Solicitado', 'campo' => 'solicitado', 'tipo' => 'numeric', 'decimales' => 4, 'class' => 'text-right']);
    ...
    public function store()
    {
        ...
        if (Input::has('btnAutorizar')) {
            ...
            $result = DB::transaction(function () use ($elID, $cantidad, $comentario, $emision) {
                ...
                $certificado->partidaid          = $info->partidaid;
                ...
                $movimiento->tipomovimientoid = 2; //Certificado
                ...
                return ['emision' => $emision, 'certificado' => $certificado];
            });
            ...
            if ($result) {
                ...
                //manda email
                try {
                    Mail::send('emails/solicitudemisionresultado', [
