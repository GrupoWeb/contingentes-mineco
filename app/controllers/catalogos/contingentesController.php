...
class contingentesController extends crudController
{
    ...
    public function __construct()
    {
        ...
        Crud::setCampo(['nombre' => 'Producto', 'campo' => 'p.nombre', 'editable' => false]);
        Crud::setCampo(['nombre' => 'Tipo', 'campo' => 't.nombre', 'editable' => false]);
        Crud::setCampo(['nombre' => 'Unidad de medida', 'campo' => 'u.nombrecorto', 'editable' => false]);
        Crud::setCampo(['nombre' => 'Plantilla', 'campo' => 'pc.nombre', 'editable' => false]);
        Crud::setCampo(['nombre' => 'Producto', 'campo' => 'p.productoid', 'tipo' => 'combobox', 'query' => 'SELECT nombre, productoid FROM productos ORDER BY nombre', 'combokey' => 'productoid', 'editable' => true, 'show' => false]);
        Crud::setCampo(['nombre' => 'Unidad de medida', 'campo' => 'unidadmedidaid', 'tipo' => 'combobox', 'query' => 'SELECT CONCAT(nombre," (",nombrecorto,")") AS nombre, unidadmedidaid FROM unidadesmedida ORDER BY nombre', 'combokey' => 'unidadmedidaid', 'editable' => true, 'show' => false]);
        ...
        Crud::setCampo(['nombre' => 'Tipo correlativo', 'campo' => 'tipocorrelativoid', 'tipo' => 'combobox', 'query' => 'SELECT nombre, tipocorrelativoid FROM tiposcorrelativo', 'combokey' => 'tipocorrelativoid', 'editable' => true, 'show' => false]);
        ...
        Crud::setCampo(['nombre' => 'Normativo', 'campo' => 'contingentes.normativo', 'tipo' => 'file', 'filepath' => '/normativos/', 'class' => 'text-center']);
        Crud::setCampo(['nombre' => 'Responsable', 'campo' => 'r.nombre', 'editable' => false]);
        Crud::setCampo(['nombre' => 'Responsable', 'campo' => 'responsableid', 'tipo' => 'combobox', 'query' => 'SELECT nombre, usuarioid FROM authusuarios WHERE rolid IN (' . implode(',', Config::get('contingentes.roldace')) . ') ORDER BY nombre', 'combokey' => 'responsableid', 'editable' => true, 'show' => false]);
        Crud::setBotonExtra(['url' => 'contingente/requerimientos/{id}?tratado=' . Input::get('tratado'), 'icon' => 'glyphicon glyphicon-list-alt', 'titulo' => 'Requerimientos']);
        Crud::setBotonExtra(['url' => 'partidasarancelarias?contingente={id}', 'icon' => 'glyphicon glyphicon-th', 'titulo' => 'Fracciones arancelarias', 'class' => 'success']);

        //mantiene id en vista
        Crud::setHidden(['campo' => 'tratadoid', 'valor' => $id]);
