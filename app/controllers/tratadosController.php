<?php
class tratadosController extends BaseController {
	...
	public function __construct() {
		...
		$this->crud->setTitulo('Tratados');
		$this->crud->setTabla('tratados');
		$this->crud->setTablaId('tratadoid');
		...
		$this->crud->setPermisos($this->cancerbero->tienePermisosCrud('catalogos.tratados'));
	}
