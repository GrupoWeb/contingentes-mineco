...
class tratadosController extends crudController {
	...
	public function __construct() {
		...
		Crud::setCampo(array('nombre'=>'Nombre Corto','campo'=>'nombrecorto'));
	 	...
	 	Crud::setCampo(array('nombre'=>'Validez certificado (meses)', 'campo'=>'mesesvalidez', 'class'=>'text-right', 'reglas'=>array('numeric', 'notEmpty'), 'reglasmensaje'=>'El valor debe ser numérico'));
