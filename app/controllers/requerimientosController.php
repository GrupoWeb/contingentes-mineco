...
class requerimientosController extends BaseController {
	...
	public function __construct() {
		...
		$this->crud->setTitulo('Requerimientos');
		$this->crud->setTabla('requerimientos');
		$this->crud->setTablaId('requerimientoid');
		...
		$this->crud->setPermisos($this->cancerbero->tienePermisosCrud('catalogos.requerimientos'));
	}
