...
class ModulosSeeder extends Seeder {
    ...
    DB::table('authmodulos')->insert(array(
		...
		DB::table('authmodulos')->insert(array(
			'moduloid'       => 42,
			'nombre'         => 'catalogonoticias',
			'nombrefriendly' => 'Catalogos - Noticias',
			'descripcion'    => ''
		));
		...
		DB::table('authmodulos')->insert(array(
			'moduloid'       => 43,
			'nombre'         => 'noticias',
			'nombrefriendly' => 'Noticias',
			'descripcion'    => ''
		));

		DB::table('authmodulos')->insert(array(
			'moduloid'       => 44,
			'nombre'         => 'solicitudliquidacion',
			'nombrefriendly' => 'Solicitudes - Liquidación',
			'descripcion'    => ''
		));

		DB::table('authmodulos')->insert(array(
			'moduloid'       => 45,
			'nombre'         => 'solicitudespendientes.liquidacion',
			'nombrefriendly' => 'Solicitudes Pendientes - Liquidación',
			'descripcion'    => ''
		));
		...
		DB::table('authmodulos')->insert(array(
			'moduloid'       => 47,
			'nombre'         => 'indicadoresgestion',
			'nombrefriendly' => 'Indicadores de gestión',
			'descripcion' => ''
		));
