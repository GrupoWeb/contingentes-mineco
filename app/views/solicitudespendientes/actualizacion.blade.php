...
@section('content')
	...
	<div class="contenido contenido-full">
		<div class="col-sm-12">
			...
			<div class="col-sm-10">{{$solicitud->propietario}}</div>
			<div class="col-sm-2"><strong>Domicilio Fiscal:</strong></div>
			<div class="col-sm-10">{{$solicitud->domiciliofiscal}}</div>
			<div class="col-sm-2"><strong>Domicilio Comercial:</strong></div>
			<div class="col-sm-10">{{$solicitud->domiciliocomercial}}</div>
			<div class="col-sm-2"><strong>Dir. Notificaciones:</strong></div>
			<div class="col-sm-10">{{$solicitud->direccionnotificaciones}}</div>
			<div class="col-sm-2"><strong>Teléfono:</strong></div>
			<div class="col-sm-10">{{$solicitud->telefono}}</div>
			<div class="col-sm-2"><strong>FAX:</strong></div>
			<div class="col-sm-10">{{$solicitud->fax}}</div>
			<div class="col-sm-2"><strong>Encargado:</strong></div>
			<div class="col-sm-10">{{$solicitud->encargadoimportaciones}}</div>
			<div class="col-sm-2"><strong>Código VUPE:</strong></div>
			<div class="col-sm-10">{{$solicitud->codigovupe}}</div>
