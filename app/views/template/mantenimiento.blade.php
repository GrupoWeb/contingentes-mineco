...
<body>
  <div class="text-center">
    <h3 class="text-primary">Contingentes Arancelarios - Ministerio de Economía</h3>
    <hr>
    Porfavor actualiza tu dirección a la siguiente:
    <a href="https://contingentesarancelarios.mineco.gob.gt">https://contingentesarancelarios.mineco.gob.gt</a>
  </div>
</body>
</html>