...
@endif
	...
	{{ Form::open(array('url' => 'catalogos/productorequerimiento/crear')) }}
	{{ Form::hidden('productoid', Crypt::encrypt($productoN->productoid)) }}
			<div class="col-md-4">
				<div class="panel panel-default">
				  <div class="panel-heading">
				    <h3 class="panel-title">{{$productoN->nombre}}&nbsp;<small>Asignación</small></h3>
				  </div>
			...
			<div class="col-md-4">
				<div class="panel panel-default">
				  <div class="panel-heading">
				    <h3 class="panel-title">{{$productoN->nombre}}&nbsp;<small>Emisión</small></h3>
				  </div>
				  <div class="panel-body">
				  		<div class="pull-right">
				...
				<div class="panel panel-default">
				  <div class="panel-heading">
				    <h3 class="panel-title">{{$productoN->nombre}}&nbsp;<small>Inscripción</small></h3>
				  </div>
				  <div class="panel-body">
				  		<div class="pull-right">
					...
					@foreach($requerimientos as $requerimiento)
						<div>
							<label>
								<input type="checkbox" value="{{$productoN->productoid}}-{{$requerimiento->requerimientoid}}"  name='reqInscripcion[]' id="mp{{$productoN->productoid.'-'.$requerimiento->requerimientoid}}" class="chkIn{{$productoN->productoid}}" v
