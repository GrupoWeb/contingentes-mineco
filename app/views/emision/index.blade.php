                ...
                <div class="col-md-2 col-sm-6 div-contingente">
                    <div class="input-group">
                        <input type="text" name="cantidad" class='form-control two-digits' data-bv-notEmpty='true'
                            ...
                            data-bv-greaterthan-message='La cantidad debe ser mayor que cero' autocomplete='off'>
                        <span class="input-group-addon" id="unidad"></span>
                    </div>
                    <input type="hidden" name="disponible" value="">
                </div>
            </div> <!-- cantidad -->
            <div class="form-group">
                <label for="disponible" class="col-sm-2 control-label"><span id="disponible">Máximo
                        Disponible</span></label>
                <div class="col-sm-6 div-contingente">
